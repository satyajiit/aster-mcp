      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="p-6 rounded-2xl bg-surface-raised border border-border-dim">
          ...
          <p class="text-xs text-text-secondary mb-3">
            Available as a skill on <a href="https://clawhub.ai/satyajiit/aster" target="_blank" rel="noopener" class="text-aster hover:underline">ClawHub</a> for OpenClaw, MoltBot, and ClawBot.
          </p>
          <div class="rounded-lg bg-surface border border-border-dim overflow-hidden">
            ...
            <pre class="terminal p-3 text-xs"><code><span class="prompt">$</span> <span class="text-text-primary">clawhub install satyajiit/aster</span></code></pre>
          </div>
        </div>
